@extends('backend.layouts', ['activeMenu' => 'INSTITUSI', 'activeSubMenu' => 'Layanan'])
@section('content')
<!--begin::Card Form-->
<div class="card" id="card-formService" style="display: none;">
    <!--begin::Card header-->
    <div class="card-header">
        <div class="card-title"></div>
        <div class="card-toolbar">
            <div class="d-flex justify-content-end">
                <button type="button" class="btn btn-sm btn btn-bg-light btn-color-danger me-2" id="btn-closeFormService" onclick="_closeCard('form_service');"><i class="fas fa-times"></i> Tutup</button>
            </div>
        </div>
    </div>
    <!--end::Card header-->
    <!--begin::Form-->
    <form id="form-service" class="form" onsubmit="return false">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            <input type="text" name="name" id="name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" maxlength="150" placeholder="Isikan nama layanan ..." />
                        </div>
                    </div>
                    <!--end::Input group-->
                    <!--begin::Input group-->
        ...
        <div class="card-footer d-flex justify-content-end py-6 px-9">
            <button type="button" class="btn btn-light btn-active-light-danger me-2" id="btn-reset" onclick="_clearFormService();"><i class="las la-redo-alt fs-1 me-3"></i>Batal</button>
...
<div class="card shadow" id="card-dtServices">
    <!--begin::Card header-->
    <div class="card-header">
        <div class="card-title">
            <h3 class="fw-bolder fs-2 text-gray-900">
                <i class="fas fa-th-list fs-2 text-gray-900 me-2"></i> Data Layanan
            </h3>
        </div>
        <div class="card-toolbar">
            <div class="d-flex justify-content-end">
                <button type="button" class="btn btn-sm btn-primary me-2" id="btn-addService" onclick="_addService();"><i class="las la-plus fs-3"></i> Tambah</button>
            </div>
        </div>
    </div>
    <!--end::Card header-->
    <div class="card-body">
            ...
            <div class="ms-auto">
                ...
                <div class="d-flex align-items-center position-relative mb-md-0 mb-3">
                    <div class="input-group input-group-sm input-group-solid border">
                        ...
                        <input type="text" class="form-control form-control-sm form-control-solid border-left-0" name="search-dtServices" id="search-dtServices" placeholder="Pencarian..." />
                        <span class="input-group-text border-left-0 cursor-pointer text-hover-danger" id="clear-searchDtServices" style="display: none;">
        ...
        <div class="table-responsive">
            <!--begin::Table-->
            <table class="table table-rounded align-middle table-row-bordered border" id="dt-services">
                <thead>
